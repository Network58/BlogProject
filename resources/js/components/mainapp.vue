        ...
        <!--========== ADMIN SIDE MENU one ========-->
            <div class="_1side_menu" >
                ...
                <div class="_1side_menu_list">
                    ...
                    <li><router-link to="/roles"><Icon type="ios-speedometer" />Admin Roles</router-link></li>
                    <li><router-link to="/assignrole"><Icon type="ios-speedometer" />Assign Roles</router-link></li>-->
